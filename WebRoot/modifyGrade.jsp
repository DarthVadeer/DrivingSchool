...
<html>
  ...
  <body>
    ...
    <center>
		<h3>	 修改成绩信息				
			<form name="modifyGrade" method="post" action="servlet/modifyGrade?id=<%=request.getParameter("id") %>">
			<table width="465" border="o.2" cellpadding="0" cellspacing="0" height="333">
				
				<%
				String id=request.getParameter("id");
				String sql1="SELECT * FROM grade_view WHERE id="+id;
				DB db1 = new DB();
				db1.connectMySQL();
			    ...
			    %>
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<SELECT NAME="cname" value="<%=rs1.getString("cname")%>">
								 <OPTION VALUE="<%=rs1.getString("cname")%>">  <%= rs1.getString("cname")%>
		   						 <OPTION VALUE="理论">	 理论					
		 					     <OPTION VALUE="倒车">	 倒车	
		  						 <OPTION VALUE="路考">	 路考	  		
	    					 </SELECT>		<br>	
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							 <input name="last_time" type="text" value="<%=rs1.getString("last_time")%>" id="lastTime"  readonly="true">
              				 <br>
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text" name="times" value="<%=rs1.getString("times")%>">
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text"  name="grade" value="<%=rs1.getString("grade") %>">
